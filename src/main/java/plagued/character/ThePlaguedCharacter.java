...
import plagued.cards.attacks.starter.Strike_Ash;
import plagued.cards.attacks.starter.Sweep;
import plagued.cards.skills.starter.Defend_Ash;
import plagued.cards.skills.starter.Evade;
import plagued.relics.starter.ArtificialWing;

import java.util.ArrayList;

import static plagued.ThePlagued.characterPath;
import static plagued.ThePlagued.makeID;

public class ThePlaguedCharacter extends CustomPlayer {
    //Stats
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass THE_PLAGUED;
        @SpireEnum(name = "CHARACTER_ASH_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "CHARACTER_ASH_COLOR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new ThePlaguedCharacter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public AbstractPlayer newInstance() {
        ...
        return new ThePlaguedCharacter();
    }
}
