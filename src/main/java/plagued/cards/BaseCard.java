package plagued.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import plagued.ThePlagued;
import plagued.util.CardStats;
import plagued.util.TriFunction;
...
import static plagued.util.GeneralUtils.removePrefix;
import static plagued.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return ThePlagued.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    ThePlagued.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
